...
CREATE TABLE `comment`  (
                            `id` bigint(0) NOT NULL DEFAULT 0 AUTO_INCREMENT,
...
CREATE TABLE `user`  (
                         ...
                         `userRole` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'user' COMMENT '用户角色：user / admin/vip',
